...
def test_add_employee_invalid(username: str, password: str, dashboard_page: DashboardPage, pim_page: PimPage, login_page: LoginPage) -> None:
    '''
    Test to add an invalid employee without username.
    '''
    ...
    pim_page.fill_form_employee(False)

    assert pim_page.verify_existence_of_required_text()